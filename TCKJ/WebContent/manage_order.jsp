...
<div class="order">
	...
	<c:forEach items="${sessionScope.orderlist1}" var="orderlist1s">	
	<tr>
		<td>${orderlist1s.time}</td>
		<td>${orderlist1s.username}</td>
		<td>${orderlist1s.tel}</td>
		<td>${orderlist1s.goodsname}</td>
		<td>${orderlist1s.type}</td>
		<td>${orderlist1s.price}</td>
		<td>${orderlist1s.time2}</td>
	</tr>
	</c:forEach>
	</table>
</div>	
