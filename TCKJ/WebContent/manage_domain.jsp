	...
	<div class="container">
		...
		<div class="h_menu4"><!-- start h_menu4 -->
	        <a class="toggleMenu" href="#">菜单</a>
				<ul class="nav">
					<li><a href="manage_order">订单管理</a></li>
					<li><a href="manage_user">用户列表</a></li>
					<li class="active"><a href="manage_domain">域名注册列表</a></li>
...
<div class="order">
	...
	<c:forEach items="${sessionScope.domain}" var="domains">	
	<tr>
		<td>${domains.damainid}</td>
		<td>${domains.name}${domains.suffix}</td>
		<td>${domains.time}</td>
		<td><a class="delete" href="deledomain?id=${domains.damainid}">删除</a></td>
	</tr>
	</c:forEach>
	</table>
</div>
<div class="add_domain">
	<span class="m_25">新增域名<label></label></span>
	<form action="domain1" method="post">
					<input type="text" name="domaininput">
